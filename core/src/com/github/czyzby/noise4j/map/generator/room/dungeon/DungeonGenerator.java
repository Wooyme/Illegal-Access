...
public class DungeonGenerator extends AbstractRoomGenerator {
    protected static DungeonGenerator INSTANCE;

    // Settings.
    protected int roomGenerationAttempts;
    protected float wallThreshold = 1f;
    protected float floorThreshold = 0.5f;
    protected float corridorThreshold;
    protected float windingChance = 0.15f;
    protected float randomConnectorChance = 0.01f;
    protected int deadEndRemovalIterations = Integer.MAX_VALUE;

    // Control variables.
    protected final List<Room> rooms = new ArrayList<Room>();
    protected final List<Direction> directions = new ArrayList<Direction>();
    protected Int2dArray regions;
    protected int currentRegion;
    protected int lastRoomRegion;
    ...
    protected int getDefaultRoomsAmount(final Grid grid) {
    ...
    protected boolean findDeadEndNeighbor(final Grid grid, final Point deadEnd) {
        for (final Direction direction : Direction.values()) {

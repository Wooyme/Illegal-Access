...
public class Grid extends Array2D {
    ...
    public Grid(final float[] grid, final int width, final int height) {
        super(width, height);
        this.grid = grid;
        visibleGrid = new boolean[grid.length];
    ...
    public boolean getVisibility(final int x, final int y) {
        return visibleGrid[toIndex(x, y)];
    }
    ...
    public void setVisibility(final int x, final int y, final boolean value) {
        visibleGrid[toIndex(x, y)] = value;
    }

    public void setType(final int x, final int y,final int value){
        typeGrid[toIndex(x,y)] = value;
    }
